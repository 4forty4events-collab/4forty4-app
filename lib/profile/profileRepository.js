...
// Set the caller's avatar to an already-hosted (R2) public URL. Separate from
// updateProfileMetadata because the upload flow commits it on its own, outside the
// bio/interests "Save changes" batch — a picked photo saves immediately.
